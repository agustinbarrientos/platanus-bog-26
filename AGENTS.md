...
- Keep application code under `src/` and imports on the `@/*` alias.
- Keep custom project types in `src/types.ts`.

## Implementation

- Prefer Server Components and add client boundaries only for browser behavior.
